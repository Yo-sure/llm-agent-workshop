#!/usr/bin/env python3
"""
MCP-based Trading Bot with Web UI Human-in-the-Loop System

구성요소:
- MCP Server(trade): trading_mcp_server.py (STDIO 통신)
- LangGraph Agent: ReAct prebuilt + MCP tools + HITL
- Web UI: FastAPI (Port 8080) + WebSocket
- 승인 시스템: 실시간 승인 요청/응답
